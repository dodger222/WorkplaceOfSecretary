...
namespace WorkplaceOfSecretary.Controllers
{
    public class GroupController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,IdSpecialty,NumberOfGroup")] Group @group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,IdSpecialty,NumberOfGroup")] Group @group)
        {
            if (id != @group.ID)
            {
                return NotFound();
